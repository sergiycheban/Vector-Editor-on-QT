...
QPointF Ellipse::previousPosition() const
{
    return m_previousPosition;
}

void Ellipse::setPreviousPosition( const QPointF previousPosition )
{
...
QVariant Ellipse::itemChange( QGraphicsItem::GraphicsItemChange change, const QVariant& value )
{
    switch ( change )
    {
...
void Ellipse::resizeLeft( const QPointF& pt )
{
    QRectF tmpRect = rect();
...
void Ellipse::resizeRight( const QPointF& pt )
{
    QRectF tmpRect = rect();
...
void Ellipse::resizeBottom( const QPointF& pt )
{
    QRectF tmpRect = rect();
...
void Ellipse::resizeTop( const QPointF& pt )
{
    QRectF tmpRect = rect();
...
void Ellipse::rotateItem( const QPointF& pt )
{
    QRectF tmpRect = rect();
...
void Ellipse::setPositionGrabbers()
{
    QRectF tmpRect = rect();
